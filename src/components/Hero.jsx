...
const Hero = () => {
  ...
  return (
    <div className="relative h-dvh w-screen overflow-x-hidden">
      ...
      >
        ...
        <div className="absolute left-0 top-0 z-40 size-full bg-black/30">
          <div className="mt-24 px-5 sm:px-10">
            <h1 className="special-font hero-heading text-[500px] text-blue-100 flex gap-2 items-center">
              <span>GTA</span>{" "}
              <img
                src="/img/vi.png"
                alt="six"
            ...
            <p className="mb-5 max-w-80 font-robert-regular text-xl text-blue-100 ">
      ...
      <h1 className="special-font hero-heading absolute bottom-5 right-5 text-[500px] text-black">
        G<b>A</b>MING
      </h1>
    </div>
  );
